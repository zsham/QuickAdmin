...
<textarea class="form-control" name="desc"></textarea>
					...
					<div class="card-footer">
						<div class="row">
							<div class="col-md-12">								<button class="btn btn-sm btn-primary col-sm-3 offset-md-3"><span class="fas fa-window-restore"></span></button>
...
<table class="table table-bordered">
							...
							<tbody>
								<?php 
								$i = 1;
								$cats = $conn->query("SELECT * FROM item_categories order by id asc");
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_cat" type="button" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $row['name'] ?>" data-desc="<?php echo $row['desc'] ?>" data-cover_img="<?php echo $row['cover_img'] ?>"><span class="fas fa-edit"></span></button>
...
$('table').dataTable()
	...
	$('.edit_cat').click(function(){
		...
		cat.find("[name='desc']").val($(this).attr('data-desc'))
