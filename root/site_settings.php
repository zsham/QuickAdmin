		...
		<div class="card-body">
			<form action="" id="manage-settings">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="name" name="name" value="<?php echo isset($meta['faculty_name']) ? $meta['faculty_name'] : '' ?>" required>
				</div>
				<div class="form-group">
					<label for="email" class="control-label">Faculty email</label>
					<input type="email" class="form-control" id="email" name="email" value="<?php echo isset($meta['email']) ? $meta['email'] : '' ?>" required>
				</div>
				<div class="form-group">
					<label for="contact" class="control-label">Faculty Contact</label>
					<input type="text" class="form-control" id="contact" name="contact" value="<?php echo isset($meta['contact']) ? $meta['contact'] : '' ?>" required>
				</div>
				<div class="form-group">
					<label for="about" class="control-label">Faculty About Content</label>
				...
				<center>
					<button class="btn btn-info btn-primary btn-block col-md-2">Save <span class="fas fa-save"></span></button>
				</center>
			</form>
		</div>
	</div>
